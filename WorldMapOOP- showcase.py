...
R19A = Rooms('This is the safe room', None, None, None, None, "There's some items in the room type search to see them"
             "now push take to take them with the number of said item", None, None, [written_paper, wooden_bat])
parking_lot = Rooms('The parking lot', None, None, None, None, "Its the destroyed parking lot but it has a bad feeling"
...
high_way = Rooms('Its the high way', None, None, None, None, "Its the highway with crashed vehicles everywhere there's"
                                                             "nowhere else to go,there's something dark in the corner "
                                                             "of my eye its  staring at me i cant move like there's a "
                                                             "presence around me", None, None, [flash_light])
parking_lot_2 = Rooms('The other part of the parking lot', None, None, None, None, "another parking lot area, I turn"
                                                                                   " to leave but a sharp pain hits my "
                                                                                   "back everything goes black : Dead")
...
mall_hallway = Rooms('The mall hallway', None, None, None, None, "Its the malls destroyed and empty hallway I have a "
                     "bad feeling with this push inventory to see the items", None, None, [nerf_gun])
